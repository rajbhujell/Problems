...
export default function Paid() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background-color p-5">
      ...
      <div className="flex flex-wrap justify-center gap-6">
        {/* Rs 100 Support */}
        <div className="bg-black shadow-[0_4px_30px_rgba(255,255,255,0.1)] rounded-lg p-6 w-full max-w-xs flex flex-col">
          <h2 className="text-xl font-semibold mb-4 text-gray-200">
            Rs 100 Support
          </h2>
          <p className="mb-4 text-gray-400">
            Write your message, and we'll send you an email after we read it.
          </p>
        ...
        <div className="bg-black shadow-[0_4px_30px_rgba(255,255,255,0.1)] rounded-lg p-6 w-full max-w-xs flex flex-col">
          ...
          <p className="mb-4 text-gray-400">
            Need immediate help? Call us for Rs 500.
          </p>
          <a
            href="tel:9820362353"
        ...
        <div className="bg-black shadow-[0_4px_30px_rgba(255,255,255,0.1)] rounded-lg p-6 w-full max-w-xs flex flex-col">
          ...
          <p className="mb-4 text-gray-400">
            For Rs 2000, we will cry with you.
          </p>
          <a
